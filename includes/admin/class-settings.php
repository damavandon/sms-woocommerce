...
class  Settings {
	...
	public function otp_option_save( $options ) {
		...
		$init['meta_key'] = $options['otp_meta_key'];
	...
	public function tabs() {
		...
		$otp = [
			...
			'fields' => [
				...
				[
					'id'         => 'otp_meta_key',
					'title'      => esc_html__( 'Meta key', 'payamito-woocommerce' ),
					'desc'       => esc_html__( 'Write a meta field on the invoice page where the user enters the mobile number', 'payamito-woocommerce' ),
					'type'       => 'text',
				...
				[
					...
					'title'      => esc_html__( 'Force enter phone number', 'payamito-woocommerce' ),
					'desc'       => esc_html__( 'By activating this option, the user must enter the mobile number when completing the WooCommerce checkout form.', 'payamito-woocommerce' ),
					'dependency' => [ "otp_active", '==', 'true' ],
					'type'       => 'switcher',
				],
				[
					'id'         => 'user_add_phone_number_field_force_OTP',
					'title'      => esc_html__( 'Forcing OTP', 'payamito-woocommerce' ),
					'desc'       => esc_html__( 'By activating this option, your user will have to confirm her mobile number via sms when registering the order.', 'payamito-woocommerce' ),
					'dependency' => [ "otp_active", '==', 'true' ],
					'type'       => 'switcher',
				],
				[
	...
	public function user_tab() {
		$user_tab = [
			...
			'fields' => [
				...
				[
					'id'         => 'user_meta_key',
					'title'      => esc_html__( 'Meta keys', 'payamito-woocommerce' ),
					'desc'       => esc_html__( 'Meta key is actually a field in which the user enters her mobile number during registration.', 'payamito-woocommerce' ),
					'type'       => 'select',
					'attributes' => [
	...
	public function dokan_is_active() {
				...
				[
					...
					'fields' => [
						...
						[
							...
							'help'       => payamito_dynamic_text( 'pattern_ID_help' ),
							'class' => 'pattern_background',
							'dependency' => [ $user_type . "_" . $slug . "_active_p" . "|" . $user_type . "_" . $slug . "_active", '==|==', 'true|true' ],
						],
