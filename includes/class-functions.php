...
if (!class_exists("Functions")) {
    ...
    class Functions
    {
        ...
        public static function english_number_to_pershian($arg)
        {
            global $pwoo_general_options;
            if (!isset($pwoo_general_options['english_number_to_pershian']) || $pwoo_general_options['english_number_to_pershian'] == '0') {
                return $arg;
            }
        ...
        public static function option_preparation($options)
        {
            ...
            if ($options['administrator_active'] != '1' && $options['user_active'] != '1') {
