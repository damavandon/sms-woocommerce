...
if (!class_exists('payamito_woocommerce')) :
	...
	final class Payamito_Woocommerce
	{
		...
		{
			new Payamito\Woocommerce\Required\Required();
		}
		...
		{
			if (isset($_GET['page']) && $_GET['page'] === 'payamito' || $_GET['page'] === 'payamito_logs') {
				wp_enqueue_script("payamito-woocommerce-admin-js",  PAYAMITO_WC_URL . "/includes/admin/assets/js/admin-app.js", array('jquery'), false, true);
			}
		}
		...
		public function include_files()
		{
			...
			require_once PAYAMITO_WC_DIR . '/includes/class-plugins-required.php';
		...
		public static function modules_activate_or_deactivate($action)
		{

			self::include_modules();
			$modules = new  Payamito\Woocommerce\Modules\Modules();
			switch ($action) {
