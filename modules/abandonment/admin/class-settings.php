            ...
            $module_settings = [
                ...
                'fields' => array(
                    ...
                    [
                        ...
                        'type'   => 'repeater',
                        'dependency' => array("abandonment_active", '==', 'true'),
                        ...
                        'fields' => array(
                            ...
                            array(
                                ...
                                'dependency' => array("guest_user", '==', 'true'),
                            ),
                            array(
                                'id'          => 'meta_key',
                                'type'        => 'select',
                            ...
                            array(
                                'id'          => 'coupon_type',
                                'type'        => 'select',
                                'dependency' => array("coupon_active", '==', 'true'),
                                'options'     => [
                            ...
                            array(
                                ...
                                'chosen' => true,
                                'multiple' => true,
                                'settings' => ['width' => "100%", 'typing_text' => esc_html__('Please enter 3 or more characters', 'payamito-woocommerce')],
